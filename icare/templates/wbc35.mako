...
<ul class="breadcrumb">
  ...
  <li class="active">ทะเบียนเด็ก 3 - 5 ปี</li>
</ul>

<ul class="nav nav-tabs">
  <li class="active"><a href="#home" data-toggle="tab"><i class="fa fa-windows"></i> ทะเบียนเด็ก 3 - 5 ปี <span class="badge" id="spn_total">0</span></a></li>
...
<script src="/static/js/apps/wbc35.js"></script>